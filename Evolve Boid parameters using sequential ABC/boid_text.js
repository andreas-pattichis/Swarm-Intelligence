...
if (process.argv.length == 5) {
    ...
    // console.log(cohesion_value)
    // console.log(separation_value)
...
function main(p5) {
    ...
    if (calc_norm(current[0], p5) > 0) {
        vector_sum = current[0].div(calc_norm(current[0], p5))
    } else {
    ...
    measure = 1 / Nb * calc_norm(vector_sum)
    console.log(measure)
